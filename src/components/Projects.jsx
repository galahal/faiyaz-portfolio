...
// Supported names (use exactly these filenames):
//   medihelp.png, boxquest.png, banking.png, library.png, solar.png, water.png
const PROJECT_IMAGES = {
  "MediHelp – Emergency Pharmacy Platform": "/Projects/medihelp.png",
  "BoxQuest – 2D Puzzle Game": "/Projects/boxquest.png",
  "Mobile Banking Service": "/Projects/banking.png",
  "Online Library Management System": "/Projects/library.png",
  "Smart Solar Tracker": "/Projects/solar.png",
  "Water Level Detector & Pump Controller": "/Projects/water.png",
};
...
const projects = [
  {
    ...
    codeLink: "#",
    liveLink: "https://medi-help-react.vercel.app/",
    emoji: "💊",
  },
  {
...
// ── Project image with fallback emoji ──────────────────────────────────────
function ProjectImage({ title, emoji }) {
  const [failed, setFailed] = useState(false);
  const src = PROJECT_IMAGES[title];

  if (!src || failed) {
    return (
      <div className="w-full h-44 rounded-xl bg-gray-100 dark:bg-white/5
                      flex items-center justify-center border border-gray-200 dark:border-white/10">
    ...
    <div className="min-h-screen pt-28 pb-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {filtered.map((p, i) => (
            <div key={i}
              className="group flex flex-col rounded-2xl border border-gray-200 dark:border-white/10
                         bg-gray-50/50 dark:bg-white/5 hover:border-purple-500/40
                         hover:bg-purple-500/5 transition-all duration-200 overflow-hidden">

              {/* Project image */}
              <div className="p-4 pb-1 overflow-hidden">
                <ProjectImage title={p.title} emoji={p.emoji} />
              </div>
