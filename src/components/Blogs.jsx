  ...
  const research = [
    {
      ...
      tags: ["HCI", "ICT4D", "E-Government", "Usability", "Digital Literacy", "LAUF Framework"],
      featured: true,
    },
    {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-gray-500 dark:text-gray-400 max-w-2xl text-lg leading-relaxed">
            My published research work in HCI and ICT4D, exploring digital inclusion
            and e-government accessibility in Bangladesh.
          </p>
        </div>
              ...
              >
                {r.featured && (
                  <div className="absolute top-4 right-4 inline-flex items-center gap-1.5
                                  ...
                                  border border-purple-500/30 px-2.5 py-1 rounded-full bg-purple-500/10">
                    ✦ Featured
                  </div>
                )}
                ...
                <ul className="flex flex-col gap-1.5 mb-4">
                  {r.contributions.map((c, j) => (
                    <li key={j} className="flex gap-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        <section>
          ...
          <div className="p-8 rounded-2xl border border-dashed border-gray-300 dark:border-white/10
                          bg-gray-50/30 dark:bg-white/5 flex flex-col items-center text-center gap-3">
            <span className="text-4xl">✍️</span>
            <h3 className="font-bold text-gray-900 dark:text-white">Coming Soon</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm">
              I'm working on articles about my research, engineering experiences, and HCI insights.
              Check back soon!
            </p>
          </div>
        </section>
